    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @if (auth()->user()->hasRole('merchant'))
                            <x-nav-link :href="route('merchant.portal')" :active="request()->routeIs('merchant.portal')">
                                {{ __('Merchant') }}
                            </x-nav-link>
                        @endif
                    @endauth
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <a href="{{ route('portal') }}"
                        class="text-sm text-gray-600 dark:text-gray-300 hover:underline">{{ __('Login') }}</a>
                @endauth
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @endif
                @if (auth()->user()->hasRole('merchant'))
                    <x-responsive-nav-link :href="route('merchant.portal')" :active="request()->routeIs('merchant.portal')">
                        {{ __('Merchant') }}
                    </x-responsive-nav-link>
                @endif
            @endauth
